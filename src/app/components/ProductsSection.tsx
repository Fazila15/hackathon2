...
export default function ProductSection() {
    return (
        <section className="py-16 bg-white w-full max-w-[1440px] mx-auto">
            {/* Cards Container */}
            <div className="flex justify-center gap-8 flex-wrap">
                ...
                {[
                    ...
                    <div key={index} className="w-[305px] h-[462px] flex flex-col items-center">
                        <Image
                            src={product.img}
                            alt={product.title}
                            width={305}
            ...
            <div className="flex justify-center items-center mt-8 mb-14">
                <button className="bg-gray-300 text-black w-full max-w-[305px] md:max-w-[170px] h-[56px] text-[16px] font-semibold hover:bg-gray-500 transition duration-300">
                    View Collection
                </button>
            </div>
        </section>

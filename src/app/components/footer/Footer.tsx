...
const Footer = () => {
  return (
    <div className="mx-auto sticky bottom-0 w-full h-[650px] bg-[#2A254B] gap-8 md:pt-[3rem] md:pb-[3rem] md:px-[2rem]">
      ...
      <div className="flex justify-center md:flex-row md:justify-between md:mr-5 md:pt-6 lg:flex-row lg:justify-between mt-2 ">

...
const CategoryCard = ({ product }: { product: Category }) => {
  ...
  <button  className="w-3/4 font-clash block text-center mb-2 bg-gray-400 hover:bg-white hover:text-gray-700 hover:border-2 hover:border-black text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline transition-colors duration-300 my-4">

  ...
  return (
    <div className="w-full h-auto border-2 rounded-md shadow-md hover:shadow-lg hover:scale-105 transition-transform duration-300">
      ...
      <div className="w-full flex justify-between mt-4 mr-3">
        <button  className="w-auto font-clash block text-center mb-2 bg-gray-500 hover:bg-white hover:text-gray-800 hover:border-2 hover:border-black text-white font-bold py-2 px-4 sm:px-6 rounded-full focus:outline-none focus:shadow-outline transition-colors duration-300 ml-4">
